...
def poly_offset(points: list, d: float):
    """Offsets closed polygons, same as :py:func:`opstool_1.pre.section.offset`
...
def create_polygon_patch(
    ...
    material: material obj
        The instance from :py:func:`opstool_1.pre.section.create_material`
...
def set_patch_material(geom, material=DEFAULT_MATERIAL):
    ...
    material: material obj | list[material obj]
        The material object of :py:func:`opstool_1.pre.section.create_material`.
    """
...
class FiberSecMesh:
    ...
    def get_sec_props(
        ...
        method :py:meth:`~opstool_1.preprocessing.SecMesh.get_frame_props`.
    ...
    def get_frame_props(
        ...
        method :py:meth:`~opstool_1.preprocessing.SecMesh.get_sec_props`.
    ...
    def get_stress(
        ...
        **kargs,
        ...
        method :py:meth:`~opstool_1.preprocessing.SecMesh.assign_group`.
    ...
    def _to_tcl(self, output_path, names, sec_tag, gj, fmt=":.6E"):
        with open(output_path, "w+") as output:
            output.write("# This document was created from opstool_1.SecMesh\n")
